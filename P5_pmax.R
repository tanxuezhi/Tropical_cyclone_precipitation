...
trend_max_reg<-read.csv("pmax_single_year.csv")
...
# print(ma)
ggsave(filename="newpictures/P5/max_trend.png",max2,width=10.21,height=6.664)
ggsave(filename="newpictures/P5/max_trend.pdf",max2,width=10.21,height=6.664)
