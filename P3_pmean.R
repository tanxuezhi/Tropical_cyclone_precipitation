...
trend_max_reg<-read.csv("pmean_single_year.csv")
...
# print(ma)
ggsave(filename="newpictures/P3/mean_trend.png",max2,width=9.51,height=6.164)
ggsave(filename="newpictures/P3/mean_trend.pdf",max2,width=9.51,height=6.164)
